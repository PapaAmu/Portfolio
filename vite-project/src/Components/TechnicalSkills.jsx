...
const TechnicalSkills = () => {
  ...
  <div className="container text-center" id="#tech-stack">
   ...
   <div className="row sm:col-sm-2">
    ...
    <img src="./public/assets/svg/CSS3.png" alt="CSS logo" className="pt-2 pl-2 pe-2"   />
    <h5 className="card-titl mt-2 text-bold">CSS</h5>
    </div>
    </div>
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./public/assets/svg/JavaScript_logo.png" alt="Javascript logo" className="pt-2 pl-2 pe-2"  />
    <h5 className="card-titl mt-2 text-bold">Javascript</h5>
    </div>
    </div>
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./public/assets/svg/Boostrap.png" alt="CSS logo" className="pt-2 pb-2 pl-2 pe-2"   />
    <h5 className="card-titl mt-2 text-bold">Boostrap</h5>
    </div>
    </div>
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./public/assets/svg/React.png" alt="React logo" className="pt-3 pl-2 pe-2 " />
    <h5 className="card-titl mt-2 text-bold">React</h5>
    </div>
    </div>
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./public/assets/svg/Redux.png" alt="React logo" className="pt-2 pl-2 pe-2" />
  ...
  <div className="row row-cols-3 row-cols-md-6 mt-4 mb-4">
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./public/assets/svg/Git.png" alt="Your image description" className="pt-2 pl-2 pe-2"  />
    <h5 className="card-titl mt-2 text-bold">Git</h5>
    </div>
    </div>
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./public/assets/svg/Github.png" alt="CSS logo" className="pt-2 pl-2 pe-2"   />
    <h5 className="card-titl mt-2 text-bold">Github</h5>
    </div>
    </div>
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./public/assets/svg/Firebase.png" alt="Tailwind css logo" className="pt-2 pl-2 pe-2"  />
    <h5 className="card-titl mt-2 text-bold">Firebase</h5>
    </div>
    </div>
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./public/assets/svg/tailwind.png" alt="Redux logo" className="pt-2 pl-2 pe-2"  />
    ...
    <div className="card items-center">
    <img src="./public/assets/svg/framer-motion.svg" alt="Git logo" className="pt-1 pb-0 pl-2 pe-2"  />
    <p className="card-titl mt-2 text-bold text-sm">Framer </p>
    </div>
    </div>
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./public/assets/svg/Mysql.png" alt="Github logo" className="pt-2 pl-2 pe-2"/>
