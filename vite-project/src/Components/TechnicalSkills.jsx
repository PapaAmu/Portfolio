...
const TechnicalSkills = () => {
  ...
  <div className="container text-center">
   ...
   <div className="row sm:col-sm-2">
    ...
    <img src="./svg/CSS3.png" alt="CSS logo" className="pt-2 pl-2 pe-2"   />
    <h5 className="card-titl mt-2 text-bold">CSS</h5>
    </div>
    </div>
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./svg/JavaScript_logo.png" alt="Javascript logo" className="pt-2 pl-2 pe-2"  />
    ...
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./svg/Redux.png" alt="React logo" className="pt-2 pl-2 pe-2" />
  ...
  <div className="row row-cols-3 row-cols-md-6 mt-4 mb-4">
    ...
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./svg/Firebase.png" alt="Tailwind css logo" className="pt-2 pl-2 pe-2"  />
    ...
    <div className="col-sm mt-4 mb-4">
    <div className="card items-center">
    <img src="./svg/Mysql.png" alt="Github logo" className="pt-2 pl-2 pe-2"/>
